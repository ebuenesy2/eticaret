...
<!-- Yıldırımdev/html/Yıldırımdev/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Nov 2022 14:19:11 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="cta cta-display bg-image pt-4 pb-4" style="background-image: url({{asset('/assets')}}/web/images/backgrounds/cta/bg-7.jpg);">
                <div class="container">
	            		...
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget">
	            				...
	            				<ul class="widget-list">
	            					<li><a href="about.html">About Yıldırımdev</a></li>
	            					<li><a href="#">How to shop on Yıldırımdev</a></li>
	            					<li><a href="#">FAQ</a></li>
	            					<li><a href="contact.html">Contact us</a></li>
...
<!-- Yıldırımdev/html/Yıldırımdev/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Nov 2022 14:19:12 GMT -->
</html>