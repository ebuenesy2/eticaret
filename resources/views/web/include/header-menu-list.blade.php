    ...
    <div class="header-left">
        ...
        <nav class="main-nav">
            <ul class="menu sf-arrows">
                ...
                <li class="megamenu-container {{Route::current()->getName() == 'web.index' ? 'active' : 'passive'}}"><a href="/@lang('admin.lang')/product/list" class="{{Route::current()->getName() == 'web.product' ? 'active' : 'passive'}}">Yeni Ürünler</a></li>
                <li class="megamenu-container {{Route::current()->getName() == 'web.index' ? 'active' : 'passive'}}"><a href="/@lang('admin.lang')/product/list" class="{{Route::current()->getName() == 'web.product' ? 'active' : 'passive'}}">Çok Satanlar</a></li>
