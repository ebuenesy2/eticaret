    ...
    <div class="header-left">
        ...
        <nav class="main-nav">
            <ul class="menu sf-arrows">
                ...
                <li class="megamenu-container {{Route::current()->getName() == 'web.product.editor.suggestion' ? 'active' : 'passive'}}"><a href="/{lang}/product/list/editor/suggestion" class="{{Route::current()->getName() == 'web.product.editor.suggestion' ? 'active' : 'passive'}}">@lang('admin.editorSuggestion')</a></li>
