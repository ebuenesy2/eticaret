...
<body>
    <div class="page-wrapper">
        ...
        <footer class="footer">
	            		...
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				...
	            				<div class="social-icons">
	            					<a href="{{asset('/assets')}}/web/#" class="social-icon" target="_blank" title="Facebook"><i class="icon-facebook-f"></i></a>
	            					<a href="{{asset('/assets')}}/web/#" class="social-icon" target="_blank" title="Twitter"><i class="icon-twitter"></i></a>
	            					<a href="{{asset('/assets')}}/web/#" class="social-icon" target="_blank" title="Instagram"><i class="icon-instagram"></i></a>
	            					<a href="{{asset('/assets')}}/web/#" class="social-icon" target="_blank" title="Youtube"><i class="icon-youtube"></i></a>
	            					<a href="{{asset('/assets')}}/web/#" class="social-icon" target="_blank" title="Pinterest"><i class="icon-pinterest"></i></a>
	            				</div><!-- End .soial-icons -->
	            		...
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget">
	            				...
	            				<ul class="widget-list">
	            					...
	            					<li><a href="{{asset('/assets')}}/web/#">FAQ</a></li>
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		<p class="footer-copyright">Copyright © 2019 Yıldırımdev Store. All Rights Reserved.</p><!-- End .footer-copyright -->
        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    <li class="active">
                        <a href="{{asset('/assets')}}/web/index.html">Home</a>

                        <ul>
                            <li><a href="{{asset('/assets')}}/web/index-1.html">01 - furniture store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-2.html">02 - furniture store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-3.html">03 - electronic store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-4.html">04 - electronic store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-5.html">05 - fashion store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-6.html">06 - fashion store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-7.html">07 - fashion store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-8.html">08 - fashion store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-9.html">09 - fashion store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-10.html">10 - shoes store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-11.html">11 - furniture simple store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-12.html">12 - fashion simple store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-13.html">13 - market</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-14.html">14 - market fullwidth</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-15.html">15 - lookbook 1</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-16.html">16 - lookbook 2</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-17.html">17 - fashion store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-18.html">18 - fashion store (with sidebar)</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-19.html">19 - games store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-20.html">20 - book store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-21.html">21 - sport store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-22.html">22 - tools store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-23.html">23 - fashion left navigation store</a></li>
                            <li><a href="{{asset('/assets')}}/web/index-24.html">24 - extreme sport store</a></li>
                        </ul>
                    </li>
                    <li>
    ...
    <script src="{{asset('/assets')}}/web/js/nouislider.min.js"></script>
    <!-- Main JS File -->
