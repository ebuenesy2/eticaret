                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            ...
                                            <a class="product-gallery-item" style="cursor: pointer;" >
                                                <img src="{{asset('/assets')}}/web/images/products/single/2-small.jpg" id="product_gallery" alt="product cross">
                                            </a>

                                            <a class="product-gallery-item" style="cursor: pointer;" >
                                                <img src="{{asset('/assets')}}/web/images/products/single/3-small.jpg" id="product_gallery" alt="product with model">
                                            </a>

                                            <a class="product-gallery-item" style="cursor: pointer;" >
                                                <img src="{{asset('/assets')}}/web/images/products/single/4-small.jpg" id="product_gallery" alt="product back">
                                            </a>
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="details-filter-row details-row-size">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            <a href="#" class="active">
                                                <img src="{{asset('/assets')}}/web/images/products/single/1-thumb.jpg" alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="{{asset('/assets')}}/web/images/products/single/2-thumb.jpg" alt="product desc">
                                            </a>
                                        </div><!-- End .product-nav -->
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="review-action">
                                                    <a href="#"><i class="fa fa-thumbs-up"></i>Helpful (2)</a>
                                                    <a href="#"><i class="fa fa-thumbs-down"></i>Unhelpful (0)</a>
                                    ...
                                    <div class="review">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="review-action">
                                                    <a href="#"><i class="fa fa-thumbs-up"></i>Helpful (0)</a>
                                                    <a href="#"><i class="fa fa-thumbs-down"></i>Unhelpful (0)</a>
                                                </div><!-- End .review-action -->
                                            </div><!-- End .col-auto -->
                                        </div><!-- End .row -->
