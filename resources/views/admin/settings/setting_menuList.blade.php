                            ...
                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                              ...
                              <tr>
                                  ...
                                  <td>
                                    ...
                                    @if($i !=0 )  <button class="btn btn-info" id="orderItem"  data_location="up"   data_id="{{$dbFind[$i]->id}}"   data_otherId="{{$dbFind[$i-1]->id}}"  >  <i  data_location="up"  data_id="{{$dbFind[$i]->id}}"  data_otherId="{{$dbFind[$i-1]->id}}"  class="icon-arrow-up"></i></button> @endif
