                        ...
                        <div id="editable-sample_wrapper" class="row-fluid" role="grid">
                          ...
                          <table class="table table-striped table-hover table-bordered dataTable" id="customers" aria-describedby="editable-sample_info">
                              <thead>
                                ...
                                <th role="columnheader" rowspan="1" colspan="1" >@lang('admin.purchaseAmount')</th>
                                <th role="columnheader" rowspan="1" colspan="1" >@lang('admin.purchaseUnitPrice')</th>
                                <th role="columnheader" rowspan="1" colspan="1" >@lang('admin.total')</th>
                                <th role="columnheader" rowspan="1" colspan="1" >@lang('admin.purchaseAmount') Net</th>
                            ...
                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                              ...
                              <tr>
                                  ...
                                  <td>
                                    ...
                                    <a href="/@lang('admin.lang'){{$listUrl}}/{{$dbFind[$i]->id}}/detail" title="order detail" ><button class="btn btn-warning" ><i class="icon-sitemap"></i></button></a>
