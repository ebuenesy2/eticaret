                      ...
                      <div class="clearfix">
                        ...
                        <div style="display:flex;gap: 5px;flex-wrap: wrap;margin-bottom: 25px;" >
                          ...
                          <button class="btn btn-success" href="#addModal" role="button" data-toggle="modal" >
                            <i class="icon-plus icon-white"></i> @lang('admin.newAdd') Modal 
                          </button>
                          <!-- Modal Son -->
                            ...
                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                              ...
                              <tr>
                                  ...
                                  <td  exportViewDisplay="false" >
                                    ...
                                    <button class="btn btn-info" title="modal arama"  id="searchItem" href="#searchModal" data-toggle="modal" data_id="{{$dbFind[$i]->id}}" ><i data_id="{{$dbFind[$i]->id}}" class="icon-search"></i></button>
                                    <a href="/@lang('admin.lang'){{$listUrl}}/search/{{$dbFind[$i]->id}}" title="sayfa arama" ><button class="btn btn-warning" ><i class="icon-search"></i></button></a>
