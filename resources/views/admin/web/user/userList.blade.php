                            ...
                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                              ...
                              <tr>
                                  ...
                                  <td>
                                    ...
                                    <a href="/@lang('admin.lang'){{$listUrl}}/info/{{$dbFind[$i]->id}}" title="sayfa arama" ><button class="btn btn-warning" ><i class="icon-search"></i></button></a>
