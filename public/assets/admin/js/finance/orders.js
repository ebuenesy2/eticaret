...
//! Tanım
var listUrl = "/admin/order"; //! List Adresi
    ...
    if(dateAdd == '') { 
        ...
        $.ajax({
            ...
            data: {
                ...
                product_id: $('#productAdd').val(),
                product: $('#productAdd option[value="'+product_id+'"]').html(),
                purchase_amount: $('#purchaseAmountAdd').val(),
                purchase_unit_price: $('#purchaseUnitPriceAdd').val(),
                total: $('#totalAdd').html(),
                purchase_amount_net: $('#purchaseAmountNetAdd').val(),
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(response.status == "success") {
                    ...
                    $('#productEdit option[value="'+response.DB.product_id+'"]').prop('selected', true); //! Seçim yap
                    $('#statusEdit option[value="'+response.DB.isActive+'"]').prop('selected', true); //! Seçim yap
                    $('#purchaseAmountEdit').val(response.DB.purchase_amount);
                    $('#purchaseUnitPriceEdit').val(response.DB.purchase_unit_price);
                    $('#totalEdit').html(response.DB.total);
                    $('#purchaseAmountNetEdit').val(response.DB.purchase_amount_net);
...
$("#edit_item").click(function (e) {
    ...
    var product_id = $('#productEdit').val();
    ...
    if(dateEdit == '') { 
        ...
        $.ajax({
            ...
            data: {
                ...
                product_id: $('#productEdit').val(),
                product: $('#productEdit option[value="'+product_id+'"]').html(),
                purchase_amount: $('#purchaseAmountEdit').val(),
                purchase_unit_price: $('#purchaseUnitPriceEdit').val(),
                total: $('#totalEdit').html(),
                purchase_amount_net: $('#purchaseAmountNetEdit').val(),
...
document.querySelector('#purchaseUnitPriceAdd').addEventListener('keyup', e => { resutAdd(); }); 
...
function resutAdd(){
    ...
    var purchaseUnitPrice = $('#purchaseUnitPriceAdd').val(); //!  Alış Birim Fiyatı
...
document.querySelector('#purchaseUnitPriceEdit').addEventListener('keyup', e => { resutEdit(); }); 

function resutEdit(){
    var purchaseAmount = $('#purchaseAmountEdit').val(); //! Yatırılan
    purchaseAmount = Number(purchaseAmount.replace(',','.')).toFixed(3); //! Sayı Dönüştür

    var purchaseUnitPrice = $('#purchaseUnitPriceEdit').val(); //! Çekilen
    purchaseUnitPrice = Number(purchaseUnitPrice.replace(',','.')).toFixed(3); //! Sayı Dönüştür
